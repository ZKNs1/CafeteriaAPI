...
namespace Cafeteria.Controllers
{
    public class OrderController : Controller
    {
        ...
        {   
            ...
            //Seleciona os produtos onde a 'Quantidade' é diferente de zero
            ...
            {
                //Exibe o ID e o nome do produto  
        ...
        {
            //Caso o usuário não selecione nenhum produto e clique para finalizar o pedido
            ...
            //Instancia um OrderItem para cada elemento salvo em TempData (Dados temporários)
            foreach(string key in TempData.Keys)
            {
                ...
                //Atualiza a quantidade do produto no estoque conforme com o que foi adicionado no pedido
            ...
            //Salva todas as alterações realizadas no banco de dados
            await _context.SaveChangesAsync();
        ...
        { 
            ...
            //Valida se o produto selecionado pelo usuário foi encontrado no bando de dados
            Product? stockCheck = products.Find(p=>p.Id==viewModel.SelectedProductId);
            if(stockCheck==null)
                return NotFound();

            //Verifica se a quantidade solicitada no produto tem no estoque
            if(stockCheck.Quantity >= viewModel.Quantity)
            {
                TempData[viewModel.SelectedProductId.ToString()]=viewModel.Quantity;
            }else
            {
                viewModel.Message = "There are not enough products in stock."; //Retorna mensagem caso não haja
            }
